                  ...
                  <tr key={p.id} className="transition-colors hover:bg-white/50" style={{ borderBottom: '1px solid var(--color-border)' }}>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-1">
                        <button onClick={() => setEdit(p)} className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors hover:bg-white/60" aria-label={`Edit ${p.title}`}>
                          <EditIcon className="w-4 h-4" style={{ color: 'var(--color-primary)' }} />
                        </button>
                        <button onClick={() => setDeleteConfirm(p.id)} className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors hover:bg-white/60" aria-label={`Delete ${p.title}`}>

      ...
      <div className="rounded-[16px] p-6" style={{ background: 'var(--color-surface)', boxShadow: '0 10px 25px rgba(0,0,0,0.06)' }}>
        <div className="flex items-center gap-6 mb-6">
          ...
          <div>
            ...
            <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold mt-2" style={{ background: 'rgba(122,155,118,0.15)', color: 'var(--color-primary)' }}>{user?.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Buyer'}</span>
          </div>
        </div>
      </div>

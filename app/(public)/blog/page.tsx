...
const MOCK_POSTS: BlogPost[] = [
  {
    ...
    author: { name: 'Sarah Khan', avatar: '/images/avatar-1.jpg' },
    date: '2026-08-15',
    readTime: '5 min read',
  ...
  },
  {
    ...
    author: { name: 'Ahmad Raza', avatar: '/images/avatar-2.jpg' },
    date: '2026-08-10',
    readTime: '3 min read',
  ...
  },
  {
    ...
    category: 'News',
    categorySlug: 'news',
    author: { name: 'E-Mart Team', avatar: '/images/avatar-3.jpg' },
    date: '2026-08-05',
    readTime: '2 min read',
  ...
  },
  {
    ...
    author: { name: 'Dr. Fatima Ali', avatar: '/images/avatar-1.jpg' },
    date: '2026-07-28',
    readTime: '4 min read',
  ...
  },
  {
    ...
    category: 'Health Tips',
    categorySlug: 'health-tips',
    author: { name: 'Sara Khan', avatar: '/images/avatar-2.jpg' },
    date: '2026-07-20',
    readTime: '6 min read',
  ...
  },
  {
    ...
    category: 'Recipes',
    categorySlug: 'recipes',
    author: { name: 'Ahmad Raza', avatar: '/images/avatar-3.jpg' },
    date: '2026-07-15',
    readTime: '8 min read',

        ...
        <div className="container mx-auto">
          ...
          {tags.map((tag) => (
            <Link
              ...
              className="inline-flex items-center rounded-[0.375rem] bg-primary-50 px-4 py-2 text-sm font-medium text-muted-700 hover:bg-primary hover:text-white transition-colors"
            >
              {tag.label}
            </Link>
          ))}

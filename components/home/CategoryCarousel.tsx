        ...
        <div className="mb-5 flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <div className="flex gap-2">
              <button
                ref={swiperPrevRef}
                className="swiper-prev category-carousel-prev rounded bg-warning px-3 py-2 text-secondary-800 hover:bg-warning-500"
              >
                &#10094;
              </button>
              <button
                ref={swiperNextRef}
                className="swiper-next category-carousel-next rounded bg-warning px-3 py-2 text-secondary-800 hover:bg-warning-500"
              >
                &#10095;
              </button>
            </div>
          ...
          {categories.map((category) => (
            <SwiperSlide key={category.id}>
              ...
              >
                ...
                <h4 className="mt-3 text-sm font-normal text-secondary-800">
                  {category.name}
                </h4>
              </Link>
            </SwiperSlide>

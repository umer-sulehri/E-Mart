...
const platformIcons: Record<string, React.ReactNode> = {
  facebook: <path fill="currentColor" d="M15.12 5.32H17V2.14A26.11 26.11 0 0 0 14.26 2c-2.72 0-4.58 1.66-4.58 4.7v2.62H6.61v3.56h3.07V22h3.68v-9.12h3.06l.46-3.56h-3.52V7.05c0-1.05.28-1.73 1.76-1.73Z" />,
  twitter: (
    <path
      fill="currentColor"
      ...
      <footer className="py-5">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="footer-menu">
                <Link href="/" aria-label="E-Mart Home" className="text-decoration-none">
                  <span style={{ fontFamily: 'var(--font-nunito)', fontWeight: 800, fontSize: '1.7rem', color: '#222' }}>
                      ...
                      <li key={link.id}>
                        <a href={link.url} target="_blank" rel="noopener noreferrer" className="btn btn-outline-light" aria-label={link.platform}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                            {platformIcons[link.platform] ?? platformIcons.facebook}
                          </svg>
                        </a>
                      </li>
                    ))}
                ...
                {contactPhone && (
                  <p className="mt-4 mb-1">
                    <a href={`tel:${contactPhone.replace(/[^+\d]/g, '')}`} className="text-decoration-none text-body-secondary">{contactPhone}</a>
                  </p>
                )}
                {contactEmail && (
                  <p className="mb-0">
                    <a href={`mailto:${contactEmail}`} className="text-decoration-none text-body-secondary">{contactEmail}</a>
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 offset-lg-2">
              <div className="footer-menu">
